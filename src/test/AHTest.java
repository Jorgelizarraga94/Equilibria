...
public class AHTest {
    ...
    private List<Persona> inicializarYEjecutar() {
        solver = new AlgoritmoHeuristico(personasDisponibles, incompatibilidades, requerimientos);
    ...
    @Test
    public void testHeuristicaEncuentraSolucionOptimaEnCasoIdeal() {
    ...
    @Test
    public void testHeuristicaEntregaSolucionValidaAunqueSeaSubOptima() {
        personasDisponibles.add(arq1); 
        personasDisponibles.add(arq2);
        personasDisponibles.add(test1); 
        personasDisponibles.add(test2); 
